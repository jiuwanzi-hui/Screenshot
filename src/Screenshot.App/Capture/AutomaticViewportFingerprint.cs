...
/// </summary>
internal sealed class AutomaticViewportFingerprint
{
    ...
    private AutomaticViewportFingerprint(
        uint[] samples,
    ...
    public static AutomaticViewportFingerprint Create(Bitmap bitmap)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                return new AutomaticViewportFingerprint(
                    samples,
    ...
    public bool IsSimilarTo(AutomaticViewportFingerprint other)
    {
    ...
    public bool IsStationaryComparedTo(AutomaticViewportFingerprint other)
    {
    ...
    /// </summary>
    public bool IsPreviouslySeenComparedTo(AutomaticViewportFingerprint other)
    {
        ArgumentNullException.ThrowIfNull(other);
    ...
    public bool TryLocatePreviouslySeenComparedTo(
        AutomaticViewportFingerprint other,
    ...
    private DifferenceMetrics? MeasureDifference(AutomaticViewportFingerprint other)
    {
        ArgumentNullException.ThrowIfNull(other);
