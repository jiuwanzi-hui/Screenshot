...
- [安装版 Screenshot Setup 1.3.1（GitHub）](https://github.com/jiuwanzi-hui/Screenshot/releases/latest/download/Screenshot-Setup-1.3.1-win-x64.exe)
- [免安装版 Screenshot Portable 1.3.1（GitHub）](https://github.com/jiuwanzi-hui/Screenshot/releases/latest/download/Screenshot-Portable-1.3.1-win-x64.zip)
- [安装版 Screenshot Setup 1.3.1（Gitee 国内镜像）](https://gitee.com/wwangyunhui/screenshot/releases/download/v1.3.1/Screenshot-Setup-1.3.1-win-x64.exe)
- [免安装版 Screenshot Portable 1.3.1（Gitee 国内镜像）](https://gitee.com/wwangyunhui/screenshot/releases/download/v1.3.1/Screenshot-Portable-1.3.1-win-x64.zip)

免安装版解压后直接运行 `Screenshot.exe`，不需要安装或预先配置 .NET。安装版和免安装版的数据都保存在各自程序目录的 `ScreenshotData` 中；移动或卸载程序前请按需备份该目录。1.3.1 延续现有数据布局，并会在发现 1.0.0 的 `%LocalAppData%\Screenshot` 旧数据时尝试迁移到新位置，迁移成功后删除旧目录。
...
- [Screenshot Setup 1.3.1 (GitHub)](https://github.com/jiuwanzi-hui/Screenshot/releases/latest/download/Screenshot-Setup-1.3.1-win-x64.exe)
- [Screenshot Portable 1.3.1 (GitHub)](https://github.com/jiuwanzi-hui/Screenshot/releases/latest/download/Screenshot-Portable-1.3.1-win-x64.zip)
- [Screenshot Setup 1.3.1 (Gitee China mirror)](https://gitee.com/wwangyunhui/screenshot/releases/download/v1.3.1/Screenshot-Setup-1.3.1-win-x64.exe)
- [Screenshot Portable 1.3.1 (Gitee China mirror)](https://gitee.com/wwangyunhui/screenshot/releases/download/v1.3.1/Screenshot-Portable-1.3.1-win-x64.zip)

Extract the portable archive and run `Screenshot.exe`; neither installation nor a preinstalled .NET runtime is required. Both packages store their data in `ScreenshotData` under their respective application directories, so back up that directory before moving or uninstalling the application. Version 1.3.1 retains the existing data layout and attempts to migrate legacy 1.0.0 `%LocalAppData%\Screenshot` data when found, removing the old directory after a successful migration.
