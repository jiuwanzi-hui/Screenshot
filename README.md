...
- [安装版 SnapCut Setup 3.8.1（GitHub）](https://github.com/jiuwanzi-hui/Screenshot/releases/latest/download/SnapCut-Setup-3.8.1-win-x64.exe)
- [免安装版 SnapCut Portable 3.8.1（GitHub）](https://github.com/jiuwanzi-hui/Screenshot/releases/latest/download/SnapCut-Portable-3.8.1-win-x64.zip)
- [安装版 SnapCut Setup 3.8.1（Gitee 国内镜像）](https://gitee.com/wwangyunhui/screenshot/releases/download/v3.8.1/SnapCut-Setup-3.8.1-win-x64.exe)
- [免安装版 SnapCut Portable 3.8.1（Gitee 国内镜像）](https://gitee.com/wwangyunhui/screenshot/releases/download/v3.8.1/SnapCut-Portable-3.8.1-win-x64.zip)
...
- [SnapCut Setup 3.8.1 (GitHub)](https://github.com/jiuwanzi-hui/Screenshot/releases/latest/download/SnapCut-Setup-3.8.1-win-x64.exe)
- [SnapCut Portable 3.8.1 (GitHub)](https://github.com/jiuwanzi-hui/Screenshot/releases/latest/download/SnapCut-Portable-3.8.1-win-x64.zip)
- [SnapCut Setup 3.8.1 (Gitee China mirror)](https://gitee.com/wwangyunhui/screenshot/releases/download/v3.8.1/SnapCut-Setup-3.8.1-win-x64.exe)
- [SnapCut Portable 3.8.1 (Gitee China mirror)](https://gitee.com/wwangyunhui/screenshot/releases/download/v3.8.1/SnapCut-Portable-3.8.1-win-x64.zip)
